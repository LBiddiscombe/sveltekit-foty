...
export const FAMILY_CARDS: IncidentCard[] = [
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Lovely ceremony. Honeymoon awaits.',
				effects: [
					{ type: 'morale', delta: 2 },
			...
			{
				label: 'The wedding is a disaster. Expensive and stressful.',
				effects: [
					{ type: 'morale', delta: -2 },
					{ type: 'bankBalance', delta: -3, scale: 'wage' }
				]
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Clean break. Amicable settlement.',
				effects: [{ type: 'bankBalance', delta: -3, scale: 'wage' }]
			},
			{
				label: 'Messy divorce. Took everything.',
				effects: [
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'You hire help. Manageable.',
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Dad critiques your last match. Annoying.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'They pay it back with interest!',
				effects: [{ type: 'bankBalance', delta: 1.5, scale: 'wage' }]
			},
			{
				label: 'You help them out. Family first.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
			{
				label: 'They never pay you back. Lesson learned.',
				effects: [
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'You book a staycation. Less hassle.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Romantic surprise! Partner over the moon!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{
				label: 'Lovely dinner together. Happy anniversary.',
				effects: [
					{ type: 'morale', delta: 1 },
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Serious condition. You take time off.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Substantial inheritance! Life-changing!',
				effects: [{ type: 'bankBalance', delta: 10, scale: 'wage' }]
			},
			{
				label: 'Modest sum. A thoughtful gift.',
				effects: [{ type: 'bankBalance', delta: 3, scale: 'wage' }]
			},
			{
				label: 'Tax eats most of it.',
				effects: [{ type: 'bankBalance', delta: 1, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'The business takes off! Genius!',
				effects: [{ type: 'bankBalance', delta: 4, scale: 'wage' }]
			},
			{
				label: 'You help out. Nice to support family.',
				effects: [{ type: 'bankBalance', delta: -1, scale: 'wage' }]
			},
			{
				label: 'The business fails. Lost contribution.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Destroys your boots. Again.',
				effects: [{ type: 'bankBalance', delta: -0.5, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Nice gathering. Good food, goodbyes.',
				effects: [{ type: 'bankBalance', delta: -1, scale: 'wage' }]
			},
			{
				label: 'The party is a disaster. Catering fails.',
				effects: [{ type: 'morale', delta: -1 }]
			},
			{
				label: "You send a gift. Can't make it.",
	...
	},
	{
		...
		outcomes: [
			{
				label: 'They negotiate brilliantly! Better than your old agent!',
				effects: [{ type: 'wageMultiplier', delta: 1.4 }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: "A generous cash gift! He's the best!",
				effects: [{ type: 'bankBalance', delta: 5, scale: 'wage' }]
			},
			{
				label: 'A thoughtful present. Appreciated.',
				effects: [{ type: 'bankBalance', delta: 1, scale: 'wage' }]
			},
