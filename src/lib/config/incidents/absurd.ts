...
export const ABSURD_CARDS: IncidentCard[] = [
	{
		...
		outcomes: [
			{
				label: 'You find old lucky boots in your locker. Play out of your skin!',
				effects: [{ type: 'xp', delta: 3 }]
			},
			{ label: 'The kit man lends you a spare pair. No harm done.', effects: [] },
			{
				label: 'The new boots give you blisters. Subbed off early.',
				effects: [{ type: 'appearanceSkip', delta: 1 }]
			},
			{
				label: 'You buy a new pair at the club shop.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'You befriend the goose. Mascot material!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{ label: 'You avoid the goose. Training moves elsewhere.', effects: [] },
			{
				label: 'The goose chases you. Pulled a muscle fleeing.',
				effects: [{ type: 'appearanceSkip', delta: 1 }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'You change shirt numbers. Bad form continues.',
				effects: [{ type: 'morale', delta: -1 }]
			},
			{
				label: 'You burn the shirt. Ritual complete.',
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'The haircut looks terrible. Confidence shot.',
				effects: [{ type: 'morale', delta: -2 }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'The messages are wholesome. Reputation boosted!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{ label: 'Embarrassing but harmless content.', effects: [{ type: 'morale', delta: -1 }] },
			{
				label: 'Private team tactics leaked. Club furious.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'You catch it one-handed. Incredible reflexes!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{ label: 'Training paused. Slight delay.', effects: [] },
			{
				label: 'You trip over the drone. Twisted ankle.',
				effects: [{ type: 'appearanceSkip', delta: 1 }]
			},
			{
				label: 'The drone owner is your biggest fan. Autograph time.',
				effects: [{ type: 'morale', delta: 1 }]
			}
		]
	},
	{
		...
		outcomes: [
			{
				label: 'The clip goes viral. You become a meme legend!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{ label: 'Everyone laughs. Good-natured ribbing.', effects: [] },
			{
				label: 'The club is not amused. Formal warning.',
				effects: [{ type: 'morale', delta: -1 }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: "The lookalike is handsome! You're flattered.",
				effects: [{ type: 'morale', delta: 2 }]
			},
			{ label: 'Amusing resemblance. Good for a laugh.', effects: [] },
			{
				label: 'The lookalike is a criminal. Mistaken identity.',
				effects: [{ type: 'morale', delta: -2 }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: "You buy the horse. Can't stay mad at it.",
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'It turns up in your boot. Traumatic.',
				effects: [{ type: 'appearanceSkip', delta: 1 }]
			},
			{
				label: 'You sell the snake. Too much hassle.',
				effects: [{ type: 'bankBalance', delta: 0.5, scale: 'wage' }]
			}
		]
	}
