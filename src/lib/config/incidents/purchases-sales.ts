...
export const PURCHASES_CARDS: IncidentCard[] = [
	{
		...
		outcomes: [
			{
				label: 'Appreciates in value. Shrewd investment!',
				effects: [
					{ type: 'morale', delta: 1 },
			...
			{
				label: 'You treat yourself. Looks great.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
			{
				label: 'You buy a fake. Embarrassing.',
				effects: [
					{ type: 'morale', delta: -1 },
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Insurance is astronomical. Money pit.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Perfect getaway. Value doubles!',
				effects: [
					{ type: 'morale', delta: 2 },
			...
			{
				label: 'Lovely weekends by the sea.',
				effects: [{ type: 'bankBalance', delta: -4, scale: 'wage' }]
			},
			{
				label: 'Storm damage. Costly repairs.',
				effects: [{ type: 'bankBalance', delta: -3, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Wins the Derby! Massive payout!',
				effects: [
					{ type: 'bankBalance', delta: 10, scale: 'wage' },
					{ type: 'morale', delta: 3 }
				]
			},
			{
				label: 'Placed in several races. Decent returns.',
				effects: [{ type: 'bankBalance', delta: 2, scale: 'wage' }]
			},
			{
				label: 'Pulls up lame. Expensive vet bills.',
				effects: [{ type: 'bankBalance', delta: -3, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Fun toy. Expensive to maintain.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
			{
				label: 'Engine blows on first trip. Nightmare.',
				effects: [{ type: 'bankBalance', delta: -4, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Projector breaks. Expensive repair.',
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Great for parties and fitness.',
				effects: [{ type: 'bankBalance', delta: -3, scale: 'wage' }]
			},
			{
				label: 'Maintenance nightmare. Money pit.',
				effects: [{ type: 'bankBalance', delta: -3, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Look like a million dollars. Feel unstoppable!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{
				label: 'Sharp new look. Compliments all round.',
				effects: [{ type: 'bankBalance', delta: -1.5, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'One piece is a lost masterpiece!',
				effects: [{ type: 'bankBalance', delta: 8, scale: 'wage' }]
			},
			{
				label: 'Tasteful collection. Adds class.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
			{
				label: 'Bought a print. Paid for an original.',
				effects: [
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Unique pet. Conversation starter.',
				effects: [{ type: 'bankBalance', delta: -1, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Terrible at it. Wasted money.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Nice bike. Weekend thrills.',
				effects: [{ type: 'bankBalance', delta: -1.5, scale: 'wage' }]
			},
			{
				label: 'You come off it. Minor injuries.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Massive rebate! The taxman owes you!',
				effects: [{ type: 'bankBalance', delta: 5, scale: 'wage' }]
			},
			{
				label: 'Nice rebate. Unexpected windfall.',
				effects: [{ type: 'bankBalance', delta: 2, scale: 'wage' }]
			},
			{
				label: 'You owe more tax. Expensive mistake.',
				effects: [{ type: 'bankBalance', delta: -3, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'A fan returns it intact! Faith restored!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{ label: 'Found down the back of the sofa.', effects: [] },
			{
				label: 'Gone forever. Cards replaced.',
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Collector spots your old shirt. Pays a fortune!',
				effects: [{ type: 'bankBalance', delta: 3, scale: 'wage' }]
			},
			{
				label: 'Cleared junk. Made some cash.',
				effects: [{ type: 'bankBalance', delta: 0.5, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Rare programme. Value skyrockets!',
				effects: [{ type: 'bankBalance', delta: 5, scale: 'wage' }]
			},
			{
				label: 'Nice addition to your collection.',
				effects: [{ type: 'bankBalance', delta: -1, scale: 'wage' }]
			},
			{
				label: 'You overpaid. Nobody else bid.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
	...
	},
	{
		...
		outcomes: [
			...
			{
				label: 'Relaxing break. Exactly what you needed.',
				effects: [{ type: 'bankBalance', delta: -2, scale: 'wage' }]
			},
			{ label: 'You get seasick. Miserable week.', effects: [{ type: 'morale', delta: -2 }] },
			{
				label: 'Book a villa instead. More privacy.',
				effects: [{ type: 'bankBalance', delta: -1.5, scale: 'wage' }]
			}
		]
	},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Knock strokes off your handicap! Worth every penny!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{
				label: 'Nice clubs. Enjoying the game more.',
				effects: [{ type: 'bankBalance', delta: -1, scale: 'wage' }]
			},
			{
				label: "Still can't hit straight. Clubs aren't the problem.",
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Beautiful cabinet. Collection looks elite!',
				effects: [{ type: 'morale', delta: 2 }]
			},
			{
				label: 'Fits perfectly. Medals displayed proudly.',
				effects: [{ type: 'bankBalance', delta: -0.5, scale: 'wage' }]
			},
			{
				label: 'Shelf collapses. Broken trophies everywhere.',
				effects: [{ type: 'morale', delta: -2 }]
			},
	...
	},
	{
		...
		outcomes: [
			{
				label: 'Approved in full! Generous payout!',
				effects: [{ type: 'bankBalance', delta: 5, scale: 'wage' }]
			},
			{
				label: 'Approved. Deductible applied.',
				effects: [{ type: 'bankBalance', delta: 1.5, scale: 'wage' }]
			},
			{
				label: "Rejected. Policy doesn't cover it.",
				effects: [{ type: 'bankBalance', delta: -1, scale: 'wage' }]
			},
