...
export function loadGame(adapter: SaveAdapter = localStorageAdapter): boolean {
	...
	try {
		...
		player.statsXpAtStart = state.player.statsXpAtStart ?? 0;
		player.statsGoalsAtStart = state.player.statsGoalsAtStart ?? 0;
		player.statsAppsAtStart = state.player.statsAppsAtStart ?? 0;
		player.statsChancesAtStart = state.player.statsChancesAtStart ?? 0;
		player.statsSavesAtStart = state.player.statsSavesAtStart ?? 0;
		player.statsMissesAtStart = state.player.statsMissesAtStart ?? 0;
